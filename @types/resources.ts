...
const resources = {
  ...
  'learn/deciding-when-to-start-your-public-pensions':
    learn_decidingWhenToStartYourPublicPensions,
  'learn/going-from-work-to-retirement': learn_goingFromWorkToRetirement,
  'learn/main-sources-of-retirement-income':
    learn_mainSourcesOfRetirementIncome,
  'learn/planning-to-save-for-retirement': learn_planningToSaveForRetirement,
  'learn/rules-of-thumb-for-public-pensions':
    learn_rulesOfThumbForPublicPensions,
  quiz: quiz,
} as const;
